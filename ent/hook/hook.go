...
// The FormFieldFunc type is an adapter to allow the use of ordinary
// function as FormField mutator.
type FormFieldFunc func(context.Context, *ent.FormFieldMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FormFieldFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FormFieldMutation); ok {
		return f(ctx, mv)
	}
...
// The FormSubmissionDataFunc type is an adapter to allow the use of ordinary
// function as FormSubmissionData mutator.
type FormSubmissionDataFunc func(context.Context, *ent.FormSubmissionDataMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FormSubmissionDataFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FormSubmissionDataMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FormSubmissionDataMutation", m)
}
