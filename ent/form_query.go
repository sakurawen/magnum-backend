...
func (fq *FormQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (fq *FormQuery) FirstIDX(ctx context.Context) string {
...
func (fq *FormQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (fq *FormQuery) OnlyIDX(ctx context.Context) string {
...
func (fq *FormQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (fq *FormQuery) IDsX(ctx context.Context) []string {
	ids, err := fq.IDs(ctx)
	if err != nil {
		panic(err)
	}
